export const biomarkers = [
  ...
  { id: 'eosinofilos', name: 'Eosinófilos', aliases: ['Eosinofilos'], unit: '%', category: 'Hemograma', direction: 'range', description: 'Percentagem de eosinófilos nos glóbulos brancos.' },
  { id: 'basofilos', name: 'Basófilos', aliases: ['Basofilos'], unit: '%', category: 'Hemograma', direction: 'range', description: 'Percentagem de basófilos nos glóbulos brancos.' },
  { id: 'linfocitos', name: 'Linfócitos', aliases: ['Linfocitos'], unit: '%', category: 'Hemograma', direction: 'range', description: 'Percentagem de linfócitos nos glóbulos brancos.' },
  { id: 'monocitos', name: 'Monócitos', aliases: ['Monocitos'], unit: '%', category: 'Hemograma', direction: 'range', description: 'Percentagem de monócitos nos glóbulos brancos.' },
  ...
  { id: 'proteina_c_reactiva', name: 'Proteína C Reactiva', aliases: ['Proteina C Reactiva', 'PCR'], unit: 'mg/L', category: 'Inflamação', direction: 'lower', description: 'Marcador de inflamação sistémica.' },

  { id: 'ureia_pre_dialise', name: 'Ureia (pré diálise)', aliases: ['Ureia (pré dialise)', 'Ureia pre dialise'], unit: 'mg/dL', category: 'Rim e Diálise', direction: 'lower', description: 'Ureia antes da sessão de diálise.' },
  { id: 'ureia_pos_dialise', name: 'Ureia (pós diálise)', aliases: ['Ureia (pós dialise)', 'Ureia pos dialise'], unit: 'mg/dL', category: 'Rim e Diálise', direction: 'lower', description: 'Ureia depois da sessão de diálise.' },
  ...
  { id: 'sodio', name: 'Sódio', aliases: ['Sodio'], unit: 'mmol/L', category: 'Eletrólitos e Minerais', direction: 'range', description: 'Eletrólito essencial para equilíbrio hídrico e função neuromuscular.' },
  { id: 'magnesio', name: 'Magnésio', aliases: ['Magnesio'], unit: 'mg/dL', category: 'Eletrólitos e Minerais', direction: 'range', description: 'Mineral envolvido em função muscular, nervosa e metabólica.' },
  { id: 'potassio', name: 'Potássio', aliases: ['Potassio', 'Potacio', 'K'], unit: 'mmol/L', category: 'Eletrólitos e Minerais', direction: 'range', description: 'Eletrólito crítico, especialmente relevante em diálise.' },
  { id: 'calcio_total', name: 'Cálcio Total', aliases: ['Calcio Total'], unit: 'mg/dL', category: 'Eletrólitos e Minerais', direction: 'range', description: 'Cálcio total no sangue.' },
  { id: 'fosforo_inorganico', name: 'Fósforo Inorgânico', aliases: ['Fosforo Inorganico', 'Fósforo', 'Fosforo'], unit: 'mg/dL', category: 'Eletrólitos e Minerais', direction: 'lower', description: 'Fósforo no sangue, relevante em doença renal e diálise.' },

  { id: 'paratormona_pth', name: 'Paratormona PTH', aliases: ['Paratomona PTH', 'PTH', 'Parathormona PTH'], unit: 'pg/mL', category: 'Osso e PTH', direction: 'range', description: 'Hormona paratiroideia, relevante no metabolismo cálcio-fósforo.' },
  ...
  { id: 'hemoglobina_glicada', name: 'Hemoglobina Glicada', aliases: ['HbA1c'], unit: '%', category: 'Glicose', direction: 'lower', description: 'HbA1c, média aproximada da glicose nos últimos meses.' },
  { id: 'glicemia_media_estimada', name: 'Glicemia Média Estimada', aliases: ['Glicemia Media Estimada'], unit: 'mg/dL', category: 'Glicose', direction: 'lower', description: 'Estimativa de glicemia média associada à HbA1c.' },
  { id: 'glicemia', name: 'Glicémia', aliases: ['Glicemia'], unit: 'mg/dL', category: 'Glicose', direction: 'range', description: 'Glicose no sangue no momento da colheita.' },
